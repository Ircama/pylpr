...
Please discuss the change you wish to make via an [issue](https://github.com/Ircama/PyLpr/issues) before developing a pull request.

# Bugs

You can help to report bugs by filing an [issue](https://github.com/Ircama/PyLpr/issues) on the software or on the documentation.
